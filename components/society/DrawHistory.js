...
export default function DrawHistory({ history = [], roster = [], canManage = false, onRestore }) {
  ...
  return (
    <section className="sf-card" id="sf-game-draw-history">
      ...
      {preview && (
        <div className="sf-modal-backdrop sf-draw-preview-backdrop" onClick={() => setPreviewId(null)}>
          <div className="sf-modal sf-draw-preview-modal" role="dialog" aria-modal="true" aria-labelledby="sf-draw-preview-title" onClick={(e) => e.stopPropagation()}>
