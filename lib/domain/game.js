...
/**
 * Return the player's normalized technical strength on a 0-5 scale.
 * ATA/DEF/FOR/HAB are the primary source and mirror the UI OVR rule;
 * legacy rating remains a fallback for older profiles without attributes.
 */
