...
export async function setGameTeams(gameId, teamA, teamB, teamAReserves = [], teamBReserves = []) { return result(await supabase.rpc('set_game_teams', { p_game_id: gameId, p_team_a: teamA, p_team_b: teamB, p_team_a_reserves: teamAReserves, p_team_b_reserves: teamBReserves })); }
